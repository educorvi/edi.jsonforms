...
def create_rule_for_single_select_option(scope, title):
    rule = {
        "type": "comparison",
        "operation": "equal",
        "arguments": [{"type": "atom", "path": scope, "default": ""}, title],
    }
...
def create_rule_for_multi_select_option(scope, value):
    rule = {
        "type": "exists",
        "array": {"type": "atom", "path": scope, "default": []},
...
def create_rule_for_bool(scope):
    rule = {
        "type": "comparison",
        "operation": "equal",
        "arguments": [{"type": "atom", "path": scope, "default": False}, True],
    }
    return rule
        ...
        "arguments": [
            {
                ...
                "operation": "greater",
                "arguments": [{"type": "atom", "path": scope, "default": 0}, 0],
            },
            {
                "type": "comparison",
                "allowDifferentTypes": True,
