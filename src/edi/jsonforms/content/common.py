...
class IObjectWithSchemata(model.Schema):
    ...
    e.g. Form and Wizard
    these fields are filled by an event handler with the current json-schema and
        ui-schema of the object

    also all the different forked json- and ui-schemata are stored
    """
    ...
    fieldset(
        ...
        fields=[
            "json_schema_rev",
            "ui_schema_rev",
            "forked_json_schema_rev",
            "forked_ui_schema_rev",
            "forks_rev",
        ],
    )
    json_schema_rev = schema.SourceText(
        ...
        required=False,
        description=_(
            "The contents of this field are autogenerated on save with change note. Do not edit it manually."  # noqa: E501
        ),
    )
    ...
    forked_json_schema_rev = schema.SourceText(
        title=_("Forked JSON-Schemata"),
        required=False,
        description=_(
            "The contents of this field are autogenerated on save with change note. Do not edit it manually."  # noqa: E501
        ),
    )
    forked_ui_schema_rev = schema.SourceText(
        title=_("Forked UI-Schemata"),
        required=False,
        description=_(
            "The contents of this field are autogenerated on save with change note. Do not edit it manually."  # noqa: E501
        ),
    )
    forks_rev = schema.SourceText(
        title=_("Forks"),
        required=False,
        description=_(
            "The contents of this field are autogenerated on save with change note. Do not edit it manually."  # noqa: E501
...
class IFormElement(model.Schema):
    """
    Interface for all content types that can be created within a Form, to
        check their id with an event handler (that it is unique within the Form).
    """
...
class IAdditionalInformation(IFormElement):
    ...
    intern_information = schema.Text(
        ...
        description=_(
            "Here you can provide additional information that the Software-Team should to take into account while creating the Form."  # noqa: E501
        ),
        required=False,
    )
    ...
    negate_condition = schema.Bool(
        ...
        description=_(
            "If this option is checked, all show conditions will be negated. This means that if any of the conditions is present in the request URL, the field will not be displayed."  # noqa: E501
        ),
        required=False,
        default=False,
    )
...
class IDependent(IAdditionalInformation):
    ...
    def check_dependencies(data):
        if data.dependencies:
            ...
            try:
                ...
                self_path = ""  # irrelevant, cannot depend on itself because it
                # doesn't exist yet
            ...
            for dep in dependencies:
                # check that self and object on which dependent are in the same group
                #     (complex, array or fieldset. Or Form)
                dep_base_path = get_base_path(dep)
                if not dep_base_path.startswith(self_base_path):
                    raise Invalid(
                        _(
                            "Object from which is dependent must be in the same "
                            + "Complex, Array, Fieldset or Form."
                        )
                    )

                dep_path = "/".join(dep.getPhysicalPath())
                # check that self isn't dependent from itself and that self isn't
                #     dependent from a child (in case of an Array, Fieldset, Complex)
    ...
    #     title=_('Dependent from this answer option:'),
    #     description=_("If this field(set) is only shown when a specific question is answered or an option from another question is chosen, please choose from which (option or field) it is dependent."),  # noqa: E501
    #     vocabulary="plone.app.vocabularies.Catalog",
    #     required=False
    # )
