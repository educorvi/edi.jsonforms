...
from edi.jsonforms.tests._test_schema_views import setUp_json_schema_test
    ...
    def test_multiple_fields(self):
        ...
        ref_schema = {
            ...
            "properties": {
                ...
                create_id(self.field[9]): {
                    "title": "urlfield1",
                    "type": "string",
                    "format": "hostname",
                },
                create_id(self.field[10]): {
                    "title": "emailfield0",
                    "type": "string",
                    "format": "email",
                },
                create_id(self.field[11]): {
                    "title": "emailfield1",
                    "type": "string",
                    "format": "email",
                },
                create_id(self.field[12]): {
                    "title": "datefield0",
                    "type": "string",
                    "format": "date",
                },
                create_id(self.field[13]): {
                    "title": "datefield1",
                    "type": "string",
                    "format": "date",
                },
                create_id(self.field[14]): {
                    "title": "datetime-localfield0",
                    "type": "string",
                    "format": "date-time",
                },
                create_id(self.field[15]): {
                    "title": "datetime-localfield1",
                    "type": "string",
                    "format": "date-time",
                },
                create_id(self.field[16]): {
                    "title": "timefield0",
                    "type": "string",
                    "format": "time",
                },
                create_id(self.field[17]): {
                    "title": "timefield1",
                    "type": "string",
                    "format": "time",
                },
                ...
                create_id(self.field[20]): {
                    "title": "integerfield0",
                    "type": "integer",
                },
                create_id(self.field[21]): {
                    "title": "integerfield1",
                    "type": "integer",
                },
                create_id(self.field[22]): {
                    "title": "booleanfield0",
                    "type": "boolean",
                },
                create_id(self.field[23]): {
                    "title": "booleanfield1",
                    "type": "boolean",
                },
            },
...
class ViewsJsonSchemaFormWithSelectionFieldTest(unittest.TestCase):
    ...
    def test_radio_selectionfield(self):
        ...
        ref_schema = {
            create_id(self.selectionfield): {
                "title": "a selectionfield",
                "type": "string",
                "enum": [],
            }
        }
        ...
        ref_schema = {
            ...
            "properties": {
                create_id(self.field[0]): {
                    "title": "selectionfield0",
                    "type": "string",
                    "enum": [],
                },
                create_id(self.field[1]): {
                    "title": "selectionfield1",
                    "type": "array",
                    "items": {"enum": [], "type": "string"},
                },
                create_id(self.field[2]): {
                    "title": "selectionfield2",
                    "type": "array",
                    "items": {"enum": [], "type": "string"},
                },
            },
